...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent new_note=new Intent(MainActivity.this,Newnote.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                //创建意图对象
                Intent edit_intent=new Intent(MainActivity.this,note_edit.class);
                //获取当前item的值
    ...
    public void createData(){
        ...
        String[] key_content={"content","time"};
        int[] key_time={R.id.note_content,R.id.note_time};
        adapter=new SimpleAdapter(MainActivity.this,list,R.layout.note_list,key_content,key_time);
    }
    ...
    public void DeleteNote(String value,int position){     //value为当前item的值，position为当前item的位置
        //从数据库匹配当前item值执行删除
        LitePal.deleteAll(Note.class,"content=?",value);
